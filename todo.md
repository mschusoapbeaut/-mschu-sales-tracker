...
- [x] Add Customer Email column to POS Sales tab (after Staff Name, admin only)
...
- [x] Fix: Staff dashboard not showing current + previous month data — server-side filter + UI labels updated
